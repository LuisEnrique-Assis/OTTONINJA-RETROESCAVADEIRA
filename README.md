...
O **Otto Ninja Retroescavadeira** é um projeto de robótica educacional desenvolvido por estudantes da **Universidade do Estado da Bahia (UNEB)**. O projeto consiste na adaptação do robô Otto Ninja para um modelo inspirado em uma **retroescavadeira**, unindo mobilidade, controle de movimentos e automação por meio de sistemas embarcados.
...
* Implementar uma pá traseira acionada por dois servomotores SG90 de 180°, permitindo movimentos de subida e descida com controle manual.
...
* Sensor IMU 360° (acelerômetro e giroscópio)
* Impressão 3D
* Fusion 360
* Git e GitHub
...
* Controle manual da pá traseira da retroescavadeira.
* Detecção de obstáculos utilizando sensor ultrassônico.
...
* **Luís Enrique Damasceno de Assis**
* **Lucas Santos**
* **Manuela Nascimento**
* **Fábio Braga**
...
* Sensores adicionais para navegação autônoma.
* Movimentos automáticos da retroescavadeira.
* Otimização da estrutura mecânica e eletrônica.

---

*"A robótica transforma ideias em soluções, aproximando a engenharia da inovação."*
